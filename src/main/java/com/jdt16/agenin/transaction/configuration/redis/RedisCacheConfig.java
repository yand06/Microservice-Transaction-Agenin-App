...
public class RedisCacheConfig {
    ...
    public RedisCacheManager cacheManager(
        ...
        // Cache untuk Transactions
        cacheConfigurations.put("transactions",
                createRestApiResponseCacheConfig(TransactionResponse.class, redisObjectMapper, Duration.ofMinutes(30))
        );

        // Cache untuk ReferralCodeResponse
        cacheConfigurations.put("transactionHistory",
                createRestApiResponseCacheConfig(OpenBankAccountCustomerInfoResponse.class, redisObjectMapper, Duration.ofMinutes(20))
        );

        // Cache untuk UserBalance
        cacheConfigurations.put("userBalance",
                createRestApiResponseCacheConfig(UserBalanceResponse.class, redisObjectMapper, Duration.ofMinutes(20))
        );

        // Cache untuk Products
        cacheConfigurations.put("products",
                createRestApiResponseCacheConfig(ProductsResponse.class, redisObjectMapper, Duration.ofMinutes(20))
        );

        // Cache untuk Commissions
        cacheConfigurations.put("commissions",
                createRestApiResponseCacheConfig(UserBalanceAndWalletResponse.class, redisObjectMapper, Duration.ofMinutes(20))
        );
