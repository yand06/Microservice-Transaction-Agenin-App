...
public class KafkaProducerConfig {
    ...
    @Bean
    public ProducerFactory<String, LogRequestDTO> auditLogProducerFactory() {
        ...
        // PENTING: Nonaktifkan type headers
    ...
    @Bean
    public KafkaTemplate<String, LogRequestDTO> auditLogKafkaTemplate() {
